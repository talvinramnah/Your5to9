...
st.write("Enter your office and home address to calculate the travel time to this activity")
...
if st.button('Calculate Travel Time'):
    ...
    if home_address:
        with st.spinner('Calculating...'):
            travel_time = calculate_travel_time(home_address, "Make Town - 32 Vyner Street, London, E2 9DQ, England")
            if travel_time is not None:
