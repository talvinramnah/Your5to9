...
st.write("Enter your office and home address to calculate the travel time to this Beginner Crochet Course")
...
if st.button('Calculate Travel Time'):
    if office_address:
        with st.spinner('Calculating...'):
            travel_time = calculate_travel_time(office_address, "205 Holland Park Avenue, London, W11 4XB, England")
    ...
    if home_address:
        with st.spinner('Calculating...'):
            travel_time = calculate_travel_time(home_address, "205 Holland Park Avenue, London, W11 4XB, England")
            if travel_time is not None:
